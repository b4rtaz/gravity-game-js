...
import * as gp from '../engine/gravityProcessor';

import * as so from '../objects/shipObject';
import * as oo from '../objects/orbObject';

import * as osmp from './missions/orbitShipMissionProcessor';
import * as vmp from './missions/velocityMissionProcessor';
