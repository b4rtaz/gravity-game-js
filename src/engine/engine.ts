...
import { RendererObject } from '../client/renderer';
...
export class Engine {
  ...
  public afterAddObject: LiteEvent<EngineObject> = new LiteEvent<EngineObject>();
  public afterRemoveObject: LiteEvent<EngineObject> = new LiteEvent<EngineObject>();
  public afterProcess: LiteEvent<void> = new LiteEvent<void>();
...
export abstract class EngineObject {
  ...
  public abstract getRendererObject(): RendererObject;
}
