...
import sor = require('../../objects/shipObjectRenderer');
...
export class GameCameraCoordinator extends r.CameraCoordinator {
  ...
  private _onMouseWheel: (MouseEvent) => void;
  private _onMouseDown: (MouseEvent) => void;
  private _onMouseMove: (MouseEvent) => void;
  private _onMouseUp: (MouseEvent) => void;
